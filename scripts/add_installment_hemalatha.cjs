...
async function main() {
    const schemeDocId = 'AIEodXMkGPZeXXEXAukn';
    const accountId = 'ACC-7AARHOHT';
    const userId = '7619658080';
    const date = '03-07-2026';
    const amount = 500;
    ...
    console.log("Scheme update prepared: increment monthsPaid by 1, totalPaid by 500");

    await batch.commit();
    console.log("=== SUCCESSFULLY ADDED INSTALLMENT AND UPDATED SCHEME ===");
