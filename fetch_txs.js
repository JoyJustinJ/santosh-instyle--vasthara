...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var q, snapshot, docs, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    q = (0, firestore_1.query)((0, firestore_1.collection)(db, "transactions"), (0, firestore_1.where)("userId", "==", "6380351879"));
                    return [4 /*yield*/, (0, firestore_1.getDocs)(q)];
                case 1:
                    snapshot = _a.sent();
                    docs = snapshot.docs.map(function (d) { return (__assign({ id: d.id }, d.data())); });
